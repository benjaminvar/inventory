...
Route::get('/ajax/customers/{customer}', 'CustomerController@get');
Route::post('/ajax/customers/add', 'CustomerController@store');
Route::put('/ajax/customers/{customer}/update', 'CustomerController@update');
Route::delete('/ajax/customers/{customer}/delete', 'CustomerController@destroy');